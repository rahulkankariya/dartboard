      ...
      <div className="z-10 bg-white border border-slate-200 p-5 rounded-3xl shadow-md w-80 hover:border-indigo-500 hover:shadow-xl transition-all duration-300">
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-linear-to-br from-indigo-500 to-purple-600 rounded-2xl text-white shadow-lg shadow-indigo-100">
          ...
          {/* Action Group - Now always visible */}
          ...
          {hasChildren && (
            <button 
              ...
              className={`p-1.5 rounded-full shadow-sm transition-all ${
                isExpanded ? 'bg-slate-800 text-white' : 'bg-slate-100 text-slate-500 hover:bg-indigo-100 hover:text-indigo-600'
              }`}
            >
